<template>
  ...
  <div class="container px-4 mx-auto">
    <div class="flex flex-wrap -m-8">
      <div class="w-full md:w-1/2 p-8">
        <div class="flex flex-col justify-between h-full">
          <div class="mb-8">
            ...
            <h3 class="mb-4 text-3xl font-bold font-heading leading-snug">حدث خطأ!</h3>
            <p class="text-lg text-gray-600 font-medium leading-normal md:max-w-md">الصفحة التي تبحث عنها غير موجودة</p>
          </div>
          <div>
      ...
      <div class="w-full md:w-1/3 p-8 self-end">
        <img class="mx-auto transform hover:-translate-x-4 transition ease-in-out duration-1000" src="../assets/images/er404.png" alt="">
      </div>
    </div>
  </div>
</section>
